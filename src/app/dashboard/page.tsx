...
const KalimantanMap = ({ markers }: { markers: any[] }) => {
  ...
  if (!L) {
  return (
    <div className="w-full h-[450px] flex items-center justify-center bg-slate-50/50" suppressHydrationWarning>
      <Loader2 className="animate-spin text-pln-cyan" />
    </div>
  );
}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
        ...
        <Card className="xl:col-span-8 bg-white border border-slate-200/60 shadow-xl rounded-[24px] overflow-hidden flex flex-col">
          <div className="p-7 border-b border-slate-100 flex items-center justify-between bg-slate-50/30">
            ...
            <Badge className="bg-slate-900 text-white font-mono px-3 py-1 text-[10px]">FY-2026</Badge>
          </div>
                ...
                >
                   ...
                   <div className="p-5 flex-1 flex flex-col">
                      <div className="flex items-center gap-3 mb-4">
                         ...
                         <Badge className="bg-red-50 text-[#ba1a1a] text-[9px] font-black uppercase border-none">Anomali</Badge>
